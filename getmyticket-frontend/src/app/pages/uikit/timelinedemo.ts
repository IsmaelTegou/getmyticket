...
@Component({
    ...
    template: ` <div class="grid grid-cols-12 gap-8">
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">BUS UMA237CMR: 60 places</div>
        ...
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">Bus 21d0181ep: 30 Places</div>
        ...
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">Bus CMR45LOEDG</div>
        ...
        <div class="col-span-6">
            <div class="card">
                <div class="font-semibold text-xl mb-4">Bus 234589CMR</div>
                <p-timeline [value]="events1">
                    <ng-template #content let-event>
